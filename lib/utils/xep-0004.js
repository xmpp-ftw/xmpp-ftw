...
var parseFields = exports.parseFields = function(x) {
    var fields = { fields: [] }
    ...
    x.getChildren('field').forEach(function(element) {
        ...
        if (null != element.getChild('value')) 
            field.value = _getValues(element, element.attrs.type)
...
var _getValues = function(element, type) {
    switch (type) {
        case 'boolean':
            return element.getChild('value').getText() == true
        case 'list-multi':
            var multi = []
