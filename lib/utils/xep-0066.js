...
exports.parse = function(stanza) {
    ...
    if (null != (oob = stanza.getChild('x', NS_X))) 
      return parseX(oob)
    
    if (null != (oob = stanza.getChild('query', NS_IQ)))
      return parseIq(oob)

    return {}
}

exports.build = function(stanza, oob) { }
...
var parseOob = function(stanza) {
  ...
  if (null != (value = stanza.getChildText('url')))
    data.url = value
  if (null != (value = stanza.getChildText('desc')))
